...
urlpatterns = [
    # ⚠️ creators/search/ 必须在 router 之前，否则 router 的 {pk} 会吃掉 search
    ...
    path("creators/<int:creator_id>/ai-insight/", CreatorAIInsightViewSet.as_view({"get": "retrieve"}), name="creator-ai-insight"),
